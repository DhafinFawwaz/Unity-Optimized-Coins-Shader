Shader "Custom/CoinSingleMaterial" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                v.vertex.xyz += float3(((_JumpHeight_var*Parabole( frac((_TimeSinceStart.g/_JumpDuration_var)) ))*float2(0,1)),0.0);
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float _CurrentFrame = fmod(floor((((_Width_var*_TimeSinceStart.g)/_FlipbookDuration_var)+_Width_var)),_Width_var);
